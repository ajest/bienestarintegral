			...
			saveTreatment(){
				...
				.catch(function (error) {
					if(error.response.data){
						...
						t.$emit('complete', {message:  'Ha ocurrido un problema y no se ha podido editar la tratamiento indicada. Por favor intente nuevamente más tarde', success: false, warning: false, danger: true});	
					}
