<template>
	<v-layout row wrap>
		<v-flex xs12 sm12 md12 lg12>
			<h2><i class="material-icons icon-h2">healing</i> Tratamientos</h2>
		</v-flex>
		<v-flex xs12 sm12 md12 lg12>
			<v-layout row wrap>
				...
				<v-flex xs12 sm12 md2 lg2 hidden-sm-and-down>
					<v-btn  fab big dark class="new-treatment pink pull-right" :to="{ name: 'treatments_new'}">
						<v-icon dark>add</v-icon>
				    </v-btn>
				</v-flex>
				<v-flex hidden-md-and-up>
					<v-btn class="new-treatment pink zindex20" dark medium fixed bottom right fab :to="{ name: 'treatments_new'}">
			          	<v-icon dark>add</v-icon>
			        </v-btn>
				</v-flex>
